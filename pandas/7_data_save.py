...
# reset_index(): 의미를 가지고 있는 인덱스를 제고하고 0부터 초기화
...
#       * UTF-8(전세계 모든 언어/유니코드 기반) vs EUC-KR(한국어/국내용)
...
# * 저장한 파일을 다시 읽어서 확인
save_df = pd.read_csv(save_filepath, encoding='UTF-8')
print(save_df)

# ==============================================================

# * Excel 저장
#   to_excel(파일명, index=인덱스행저장여부, encoding=인코딩정보, sheet_name=시트명)
#   - sheet_name: 저장될 시트 이름. 기본값: Sheet1
#   => 내부적으로 이미 유니코드 기밪으로 문자를 저장하도록 설계되어 있음
